...
namespace Spring.Integration.Adapter {
    ...
    public class MessageMappingException : MessagingException {
        ...
        public MessageMappingException(IMessage failedMessage, string description)
            : base(failedMessage, description) { }

        public MessageMappingException(IMessage failedMessage, string description, Exception innerException)
