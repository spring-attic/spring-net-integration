...
namespace Spring.Integration.Tests.Config
{
    ...
    public class TestChannelInterceptor : ChannelInterceptorAdapter
    {
        ...
        private readonly AtomicInteger _receiveCount = new AtomicInteger();
        ...
        {
            _receiveCount.IncrementValueAndReturn();
            return message;
        }

        public int SendCount
        {
            get { return _sendCount.Value; }
        }

        public int ReceiveCount
        {
            get { return _receiveCount.Value; }
        }
    }
}